...
function addMissingMethod(name){
  if (!Document.prototype[name]){
    Document.prototype[name] = function(){
      console.warn("document."+name+"() is not implemented in can-simple-dom with witch SSR occurs.  Please make sure this code runs after the document has finished loading, with guide at bitballs (turning of SSR) under donejs.com."
      return {};
    }
  }
}
