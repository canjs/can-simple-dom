...
var nodeRemoveChild = Node.prototype.removeChild = function(refNode) {
  ...
  this.children.splice(this.children.indexOf(refNode), 1);
...
Node.prototype.replaceChild = function(newChild, oldChild){
	...
	this.children.splice(this.children.indexOf(oldChild), 0, newChild)
	// nodeRemoveChild will remove oldChild from children.
...
/**
 * List of child elements (nodeType = 1).
