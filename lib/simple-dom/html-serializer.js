...
var metadataContentTags = ['style', 'script', 'template'];
function isMetadataContent (textNode) {
  var parent = textNode.parentNode;
  return !!(parent && metadataContentTags.indexOf(parent.nodeName.toLowerCase()) !== -1);
}
